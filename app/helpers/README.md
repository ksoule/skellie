...
## Basics
only used in views and controllers
...
so that it is "sourced" (i.e. read in) anew.  Other web frameworks do not require
this restart (e.g. Rails), but in this starter kit  you're best not "bubbling out" helpers until your implementation has "gelled."
